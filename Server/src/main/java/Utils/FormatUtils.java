...
public class FormatUtils {
    ...
    public static ClientRequestFormat byteBufToClientRequest(ByteBuf buf) {
        try {
            ...
            System.out.println("BUf String:  " + bufString);
    ...
    public static ByteBuf responseToByteBuf(ResponseFormat response) {
        try {
            ...
            System.out.println("Response : in response to ByteBuf" + jsonData);
            ...
            System.err.println("Error in ResponseToByteBuf: " + e.getLocalizedMessage());
            return null;
        }
    }
    public static RequestFormat byteBufToRequest(ByteBuf buf) {
        try {
            ...
            System.out.println("jsonString in byteBufToRequest: " + jsonString);
